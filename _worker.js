...
//        const proxyip = data.proxyStatus;
        ...
        const vlessTls = `vless://bexnxx@${hostName}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=${pathFixed}#${isp}`;
        const vlessNtls = `vless://bexnxx@${hostName}:80?path=${pathFixed}&security=none&encryption=none&host=${hostName}&fp=randomized&type=ws&sni=${hostName}#${isp}`;
...
» Path        : ${path}
===========================================
TLS: <button class="button2" onclick='copyToClipboard("${vlessTlsFixed}")'><i class="fa fa-clipboard"></i> Copy </button>
        
${vlessTls}
============================================
NTLS: <button class="button2" onclick='copyToClipboard("${vlessNtlsFixed}")'><i class="fa fa-clipboard"></i> Copy </button>
